                ...
                <div class="lg:w-[540px] w-full bg-white rounded-[48px] p-8 md:p-16 shadow-sm flex flex-col justify-center">
                    ...
                    <div class="mt-10 pt-8 border-t border-outline-variant/20">
                        ...
                        <div class="flex gap-4">
                            <a href="https://www.instagram.com/buildwithgunners?igsh=MWEwazh2bjFydXBhaQ==" target="_blank" class="w-11 h-11 bg-[#0f6e8c]/10 rounded-xl flex items-center justify-center text-[#0f6e8c] hover:bg-[#0f6e8c] hover:text-white transition-all">
