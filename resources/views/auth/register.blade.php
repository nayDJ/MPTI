<x-guest-layout :hideLogo="true" backgroundType="video">
    ...
    <form method="POST" action="{{ route('register') }}" x-data="{ submitting: false }" @submit="submitting = true">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="floating-group" x-data="{ showConfirm: false }">
        ...
        <div class="mt-4 text-center">
            <a class="text-base text-white/70 hover:text-white underline rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0F6E8C]" href="{{ route('login') }}">
                Sudah punya akun?
            </a>
        </div>
    </form>
